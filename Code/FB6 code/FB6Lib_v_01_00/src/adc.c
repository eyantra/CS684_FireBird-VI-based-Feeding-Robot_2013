...
#ifdef SERVOPOD
  LPC_PINCON->PINSEL1 &= ~0x00030000;	/*P0.24, A0.1*/
  LPC_PINCON->PINSEL1 |= 0x00010000;

  LPC_PINCON->PINMODE1 &=~0x00030000;	/*No pull up no pull down*/
  LPC_PINCON->PINMODE1 |=0x00020000;
#endif

#ifdef POT
  LPC_PINCON->PINSEL3 |= 0xC0000000;	/* A0.5, function 11 */

  LPC_PINCON->PINMODE3 &= ~0xC0000000;	/*No pull up no pull down*/
