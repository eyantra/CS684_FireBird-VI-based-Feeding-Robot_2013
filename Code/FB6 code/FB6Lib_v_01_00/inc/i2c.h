...
#define I2SCLH_SCLH			0x00000150  /* I2C SCL Duty Cycle High Reg */
#define I2SCLL_SCLL			0x00000150  /* I2C SCL Duty Cycle Low Reg */
...
extern void ResetI2C0(void);
extern void ResetI2C1(void);
...
extern volatile uint8_t I2CMasterBuffer[I2C_PORT_NUM][I2C_BUFSIZE];
extern volatile uint8_t I2CSlaveBuffer[I2C_PORT_NUM][I2C_BUFSIZE];
